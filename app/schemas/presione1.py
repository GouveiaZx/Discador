...
class MonitorCampanaResponse(BaseModel):
    ...
    campana_id: int = Field(..., description="ID da campanha")
    estado_campana: str = Field(..., description="Estado da campanha")
    llamadas_activas: List[LlamadaPresione1Response] = Field([], description="Chamadas ativas")
    ultimas_llamadas: List[LlamadaPresione1Response] = Field([], description="Últimas chamadas finalizadas")
    estadisticas: EstadisticasCampanaResponse = Field(..., description="Estatísticas atuais") 