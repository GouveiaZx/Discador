...
from app.routes import llamadas, listas, cli, stt, reportes
...
app = FastAPI(
    ...
    description="Sistema de discado predictivo con funcionalidades de manejo de llamadas, listas y reconocimiento de voz",
