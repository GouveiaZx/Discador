"""
Migración para agregar los campos resultado y fecha_finalizacion a la tabla llamadas.
"""
...
down_revision = '20230801001'  # Debe apuntar a la migración anterior
branch_labels = None
depends_on = None

def upgrade():
    """Aplica la migración: agrega las columnas resultado y fecha_finalizacion"""
    ...
    # Crear el índice para resultado
